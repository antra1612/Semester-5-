...
#generate bar graph for commit to changes ratio
counts_df = pd.read_csv('csvs/author_commit_statistics.csv',usecols=['Commit_Author_Login','Commit_ID'])
sums_df = pd.read_csv('csvs/author_statistics.csv',usecols=['Commit_Author_Login','Additions'])
combined_df = counts_df.merge(sums_df,on='Commit_Author_Login')
combined_df.to_csv('csvs/changes_commit_statistics.csv',index=False)
